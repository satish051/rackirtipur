...
// 3. Testimonial - matched with exactly 4 divs
...
// 4. Members Modal - replace board and general members
const boardRegex = /<!-- Board of Directors -->[\s\S]*?<!-- General Members -->/;
const boardReplacement = `<!-- Board of Directors -->
                <div class="mb-8">
...
const generalRegex = /<!-- General Members -->[\s\S]*?<\/div>\s*<\/div>\s*<\/div>\s*<\/div>\s*<!-- FOOTER -->/;
const generalReplacement = `<!-- General Members -->
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                        ...
                        <div class="flex items-center p-2.5 bg-gray-800/30 rounded-lg border border-gray-700/30">
                            ...
                            <div>
                                ...
                                <% if (m.role !== 'General Member') { %>
                                <p class="text-gray-500 text-xs"><%= m.role %></p>
                                <% } %>
                            </div>
                        </div>
                        <% }) %>
            ...
            <!-- Modal Footer -->
            <div class="px-6 py-5 bg-gray-800 border-t border-gray-700 flex justify-end sticky bottom-0">
    ...
    <!-- FOOTER -->`;
content = content.replace(generalRegex, generalReplacement);
